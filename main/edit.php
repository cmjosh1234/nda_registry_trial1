...
$sql = "UPDATE incoming2021 
		...
		WHERE id=?";
$q = $db->prepare($sql);
$q->execute(array($SUBJECT,$DATE_RECEIEVED,$REF,$SENDER,$TODEPT,$RECEIVED_BY,$DATE_OF_OUTGOING_LETTER,$REF_NO,$SENDING_DEPT,$DATE_RECIEVED_AT_REGISTRY,$RECIEVED_BY,$TEL,$DATE_RECIEVED,$FILE_NAME,$FILE_NO,$BOX_NO,$id));
