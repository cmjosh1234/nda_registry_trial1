...
OUTGOING LETTER<br>
<input type="date" name="DATE_OF_OUTGOING_LETTER" value="<?php echo $rows['DATE_OF_OUTGOING_LETTER']; ?>" /><br><br>
REF NO<br>
...
RECEIVED<br>
<input type="date" name="DATE_RECIEVED" value="<?php echo $rows['DATE_RECIEVED']; ?>" /><br><br>
FILE NAME<br>
